...
\item Sean $G$ una gr\'afica conexa y $e \in E$.   Demuestre que
  ...
  $\Longleftarrow$) Sea $e$ un lazo $\rightarrow e$ pertenece a un ciclo (por definición)$\rightarrow$  por contrapositiva de la Obs. 1) $e$ no es un puente $\rightarrow$ por contrapositiva del inciso a) $e$ no esta en ningun arbol generador de G.
