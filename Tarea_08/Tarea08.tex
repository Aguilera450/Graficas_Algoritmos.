...
\item Modifique el algoritmo BFS para que regrese una bipartici\'on de la
  ...
  \textbf{\textit{Soluci\'on:}} Para este ejercicio, emplearemos las siguientes estructuras de datos:
  \begin{itemize}
...
\end{enumerate}
\begin{algorithm}[H]
  \SetAlgorithmName{}{}%BipartitionOrOddCycle}{}
  \DontPrintSemicolon
  ...
  \caption{OddCycleOrBipartition$(<G,r>;L/C)$} \label{BipartitionOrOddCycle}
  \DecMargin{1em}
\end{algorithm}
\hfill $\square$
\begin{enumerate}
